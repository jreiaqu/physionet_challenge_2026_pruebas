...
========================
Búsqueda de hiperparámetros con Optuna (optimización Bayesiana) evaluada
mediante 5-fold CV estratificado. Soporta los 5 tipos de modelo del proyecto.

Uso: python hyperparameter_search.py --CV_data_dir ../cv_splits_balanced --models_dir ../models --model_type {0..4}
  Tipos: 0=SimpleCNN, 1=CNN+LSTM, 2=LSTM, 3=ResNet1D, 4=Transformer
  Guarda: <models_dir>/resultados_cv_optuna.csv y search_space.json por trial
"""
...
from models_and_training import train_model, load_model, run_model
from data_utils import HEADERS, find_patients, load_diagnoses

parser = argparse.ArgumentParser(description="Optimización de hiperparámetros de CNN con Optuna.")
parser.add_argument(
    '--CV_data_dir', 
    type=str, 
    default='/home/local/alumno.upv.es/jreiaqu/cv_splits_balanced',
    help='Ruta de la carpeta donde están los datos de validación cruzada.'
)
parser.add_argument(
    '--models_dir', 
    type=str, 
...
CV_BASE_FOLDER = args.CV_data_dir
