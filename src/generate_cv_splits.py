...
=====================
Genera los 5 folds estratificados de cross-validation con test set fijo (15%).
Verifica integridad de archivos EDF (>1 KB) antes de copiarlos.

Uso: ejecutar directamente → llama a create_kfold_splits_85_15()
Output: cv_splits_balanced/split_{0-4}/{training,val,test}_data/
Nota: ejecutar una sola vez; los splits ya generados están en cv_splits_balanced/
"""
import os
import glob
import shutil
