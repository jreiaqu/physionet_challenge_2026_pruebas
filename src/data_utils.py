...
data_utils.py
=============
Funciones de soporte para carga de datos EDF, extracción de demografía,
estandarización de nombres de canales y métricas de evaluación.
Dependencia principal de models_and_training.py, train_model.py y run_model.py.

Funciones clave:
  find_patients(), load_diagnoses(), load_signal_data()
  standardize_channel_names_rename_only(), derive_bipolar_signal()
  compute_challenge_score(), compute_auc(), update_demographics_table()
"""
...
HEADERS = {
    ...
    'prediction_binary':     'Cognitive_Impairment_Prediction',
