...
======================
Genera embeddings de señales fisiológicas usando el modelo preentrenado SleepFM.
Procesa archivos HDF5 de cada paciente y guarda embeddings por modalidad.

Dependencia: sleepFM/sleepfm-clinical/ debe estar accesible.
Output: un archivo HDF5 por paciente con embeddings de las 4 modalidades (BAS, EKG, RESP, EMG).
Ejecutar este script UNA VEZ antes de usar train_clf.py o mlp_sleepfm.py.
"""
