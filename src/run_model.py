...
run_model.py
============
Punto de entrada CLI para inferencia sobre datos nuevos con un modelo entrenado.
Itera sobre todos los pacientes de la carpeta de datos y guarda predicciones en CSV.

Uso: python run_model.py -d <datos> -m <modelo> -o <salida> [-v] [--allow_failures]
  -d  carpeta con datos de test (EDF + demographics_total.csv)
  -m  carpeta que contiene el checkpoint del modelo entrenado
  -o  carpeta donde se guardarán las predicciones
"""
...
# Cuidado, voy al _mod, esto no se permite realmente!!!
from data_utils import *
from models_and_training import load_model, run_model
