"""
quick_split_local.py
====================
Divide manualmente los datos en 80% train / 20% validación moviendo archivos EDF.
Útil para pruebas rápidas locales antes de usar el pipeline de CV completo.
No reemplaza a generate_cv_splits.py — es una herramienta auxiliar de desarrollo.
"""
